...
return [
    ...
    'account' => [
        'edit' => [
            ...
            'save-btn'          => '保存帐户',
            'title'             => '我的帐户',
            'update-success'    => '帐户更新成功',
            'upload-image-info' => '上传 PNG 或 JPG 格式的个人资料图片 (110px X 110px)',
        ],
    ],
    ...
    'leads' => [
        ...
        'update-failed'     => '无法删除线索。',
        'destroy-success'   => '线索删除成功。',
        'destroy-failed'    => '无法删除线索。',
        ...
        'index' => [
            ...
            'kanban' => [
                'rotten-days'            => '线索已逾期 :days 天',
                'empty-list'             => '您的线索列表为空',
                'empty-list-description' => '创建线索以组织您的目标。',
    ...
    'dashboard' => [
        'index' => [
            ...
            'over-all' => [
                ...
                'total-leads'           => '潜在客户总数',
                'average-leads-per-day' => '平均每日潜在客户数',
                'total-quotations'      => '总报价',
                'total-persons'         => '总人数',
                'total-organizations'   => '总组织数',
            ],
            ...
            'top-selling-products' => [
                'title'       => '热门产品',
                'empty-title' => '未找到产品',
                'empty-info'  => '所选间隔内无可用产品',
            ],

            'top-persons' => [
                'title'       => '热门人物',
                'empty-title' => '未找到人物',
                'empty-info'  => '所选时间段内没有可用的人物',
            ],
    ...
    'layouts' => [
        ...
        'settings'             => '设置',
        'user'                 => '用户',
        'user-info'            => '管理 CRM 中的所有用户及其权限，以及他们被允许执行的操作。',
        'groups'               => '组',
        'groups-info'          => '从 CRM 添加、编辑或删除组',
        'roles'                => '角色',
        'role'                 => '角色',
        'roles-info'           => '从 CRM 添加、编辑或删除角色',
        'users'                => '用户',
        'users-info'           => '从 CRM 添加、编辑或删除用户',
        'lead'                 => '潜在客户',
        'lead-info'            => '管理 CRM 中所有潜在客户相关设置',
        'pipelines'            => '管道',
        'pipelines-info'       => '从 CRM 添加、编辑或删除管道',
        'sources'              => '来源',
        'sources-info'         => '从 CRM 添加、编辑或删除来源',
        'types'                => '类型',
        'types-info'           => '从 CRM 添加、编辑或删除类型',
        'automation'           => '自动化',
        'automation-info'      => '管理 CRM 中所有自动化相关设置',
        'attributes'           => '属性',
        'attribute'            => '属性',
        'attributes-info'      => '从 CRM 添加、编辑或删除属性',
        'email-templates'      => '电子邮件模板',
        'email'                => '电子邮件',
        'email-templates-info' => '从 CRM 添加、编辑或删除电子邮件模板',
        'workflows'            => '工作流',
        'workflows-info'       => '从 CRM 添加、编辑或删除工作流',
        'webhooks'             => 'Webhook',
        'webhooks-info'        => '从 CRM 添加、编辑或删除 webhook',
        'other-settings'       => '其他设置',
        'other-settings-info'  => '管理 CRM 中所有额外设置',
        'tags'                 => '标签',
        'tags-info'            => '添加、编辑或从 CRM 中删除标签',
        'my-account'           => '我的帐户',
        'sign-out'             => '退出',
        'back'                 => '返回',
        'name'                 => '名称',
        ...
        'warehouses'           => '仓库',
        'warehouse'            => '仓库',
        'warehouses-info'      => '从 CRM 添加、编辑或删除仓库',
    ],
    ...
    'user' => [
        'account' => [
            ...
            'remove-image'          => '删除图像',
            'upload_image_pix'      => '上传个人资料图像（100px x 100px）',
            'upload_image_format'   => 'PNG 或 JPG 格式',
            'image_upload_message'  => '仅允许图像（.jpeg、.jpg、.png、..）。',
        ],
    ],
